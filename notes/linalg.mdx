...
**Determinant**<br />
The **determinant** is the factor by which a given transformation changes any area. The determinant is $0$ if the transform transforms space into a lower dimension (area/volume is $0$). Well... ish. Sorry. The determinant can be negative! This is when space is "inverted".
