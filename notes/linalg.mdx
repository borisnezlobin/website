...
**Raising a Matrix to a Power**<br />
...
If you think about it, *functions* are just like vectors, no? You can add them. You can scale them. In essence, functions are just vectors with infinitely many coordinates and bases $1, x, x^2, x^3,\dots$ instead of $\begin{bmatrix}1 \\ 0 \\ \vdots\end{bmatrix},\begin{bmatrix}0 \\ 1 \\ \vdots \end{bmatrix}$.
...
**Multi-dimensional Transformations**<br />
