            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors flex-shrink-0 disabled:opacity-30 ${
                active
                  ...
                  : "bg-transparent text-light-foreground/80 dark:text-dark-foreground/80 border border-black/20 dark:border-white/20 hover:border-black/40 dark:hover:border-white/40"
              }`}
            >
              {cat.label}
              <span
                className={`ml-1.5 ${
                  active
                    ? "text-light-background/70 dark:text-dark-background/70"
