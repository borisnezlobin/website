    ...
    return (
        <>
            <center className="w-full print:hidden bg-dark-background dark:bg-light-background flex items-center justify-center relative p-2 md:py-8 mb-2 md:px-8 md:pb-12 h-48">
                ...
                <InkscapeColoredSvg strokeWidth={0.5} path="/drawings/cornerborder.svg" color="var(--text-color)" className="hidden lg:block absolute h-full top-[-52.4%] right-[-14%]" visible={visible} />
            </center>
