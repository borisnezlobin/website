...
Of course, you may be thinking, "doesn't GitHub literally have a button called 'Embed' that gives you the embed code?" It does! Here it is:
![[Pasted image 20240726153741.png]]
The whole code of that is simple, something like
```html
