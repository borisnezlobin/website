...
When the posting asks for a skill beyond the core technical one, spend a bullet on it. Writing, presenting, or communicating findings calls for his editing, journalism, research-presentation, or debate bullets; a startup or founding role calls for a founder, client, or budget bullet; teaching or mentoring calls for the teaching bullets. One such bullet is usually enough.
