export function SectionLabel({ label }: { label: string }) {
    return (
        <div className="absolute top-4 right-4 md:top-16 md:right-16 items-center md:items-start">
            <span
                className="emph text-primary text-lg md:text-lg tracking-[0.1em] font-bold uppercase md:[writing-mode:vertical-rl] md:[text-orientation:upright] relative inline-block bg-primary text-white px-2 py-1 md:py-2"
            >
                &nbsp;{label}&nbsp;&nbsp;
