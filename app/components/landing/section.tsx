...
const Section = ({
    ...
    return (
        <div ref={ref} className={`w-full flex flex-col justify-center items-left mt-4`}>
            <h2 className="text-xl sm:text-4xl mt-12 font-bold text-left dark:text-dark transition-colors duration-300">
                {title}
            </h2>
