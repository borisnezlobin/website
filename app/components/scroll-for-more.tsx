...
const ScrollForMore = () => {
    ...
    return <div className={`absolute bottom-0 left-0 flex flex-col gap-2 justify-end items-center pb-1`}>
        <div className={`${scrolled ? "opacity-0" : ""} flex flex-row justify-center items-center w-screen gap-4 text-muted dark:text-muted-dark`}>
            <p className="text-muted dark:text-muted-dark">Scroll for more</p>
            <ArrowFatLineDown size={24} weight="thin" className="animate-bounce" />
        </div>
