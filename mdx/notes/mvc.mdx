...
**Vectors**<br />
Vectors are lists of points that represent a a linear combination of basis vectors... but that's a topic for linear algebra. In two dimensions, they're "arrows" from the origin to a point. So, the vector $\langle 3, 2\rangle$ represents "3 units across and two up."
