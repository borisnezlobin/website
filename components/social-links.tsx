...
const SocialLinksBubble = () => {
    ...
    return (
        <div className="fixed bottom-4 right-4 flex flex-row items-center justify-center gap-4 border border-muted dark:border-muted-dark p-2 px-6 rounded-full shadow-lg">
