...
Prisma Studio is terrible — you can't paste in newlines. This is unfortunate because it means that I would have to manually add `\n` at the end of every line in my markdown files — which is definitely not an option. In order to address this, I wrote a quick python script that addresses it. It can be seen above. Also, you can [find it on GitHub Gists](https://gist.github.com/borisnezlobin/91aa0b2c95d5e63264ee4da2d7649fc9). Let's try this embed:
